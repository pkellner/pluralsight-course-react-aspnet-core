...
export function sessions(state = {
    ...
    //console.log('reducer/sessions:' + action.type);
    ...
    switch (action.type) {
        ...
        case SESSION_UPDATE: {
            ...
            const newState = updateOneSession(state,sessionIdToUpdate,newInterestLevel);
            return newState;
        }

        case SESSION_UPDATE_SUCCESS: {
            console.log("SESSION_UPDATE_SUCCESS");
            ...
            console.log("SESSION_UPDATE_SUCCESS newInterestLevel:",action);
        ...
        case SESSION_UPDATE_FAIL: {
            console.log("SESSION_UPDATE_FAIL:" + action.error.message);

            const sessionIdToUpdate = action.meta.previousAction.payload.request.data.id;
